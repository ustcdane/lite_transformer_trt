...
- 运行前确保已经有 model onnx file，若无请下载 [lite.onnx](https://drive.google.com/drive/folders/1xDC8zLuH-a6Ws0l9ERsmX5UB1Ko2xkmf), 然后拷贝到  lite_transformer_trt/data_model 目录下。运行如下命令测试性能：
