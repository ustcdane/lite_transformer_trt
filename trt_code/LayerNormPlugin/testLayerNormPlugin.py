...
def run():
    ...
    inputTensorList.append( network.add_input('inputT', trtDataType, [-1,-1,512]) )

    profile = builder.create_optimization_profile()
    profile.set_shape('inputT',[1,4,512],[4,16,512],[16,64,512])
    ...
    #print(f'bs sl emb:({nBS},{nSL},{nEmbedding})\ndata:{bufferH[-1]}')
    #print(f'context.get_binding_shape(1):{context.get_binding_shape(1)}')
