...
def get_incremental_state(
    ...
    if not hasattr(module, 'get_incremental_state'):
        sys.stderr.write( 'Warning!!! get_incremental_state ' + str(module) + " has no get_incremental_state\n\n\n")
        return None
...
def set_incremental_state(
    ...
    if incremental_state is not None:
        if not hasattr(module, 'set_incremental_state'):
            sys.stderr.write( 'Warning!!! set_incremental_state ' + str(module) + " has no set_incremental_state\n\n\n")
