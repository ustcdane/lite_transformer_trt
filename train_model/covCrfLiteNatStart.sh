...
python train.py ${data_dir}  --save-dir ${save_path} \
    ...
    --length-loss-factor 0.1 --eval-bleu \
...
#    --encoder-kernel-size-list 3 3 7 7 15 15 \
#    --decoder-kernel-size-list 3 3 7 7 15 15 \
#--fp16-scale-tolerance 0.25
#    --tensorboard-logdir ${save_path}/tensorboard \
#--fp16
#--reset-optimizer
#    --ddp-backend no_c10d  --max-tokens 151888  --lr-scheduler inverse_sqrt \
