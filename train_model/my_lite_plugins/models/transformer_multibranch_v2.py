...
#import  MultiBranch
from ..modules.multibranch import MultiBranch
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def buffered_future_mask(self, tensor):
        dim = tensor.size(0)
        #print(f'--------------------dim:{dim}')
        #f=hasattr(self, '_future_mask')
        #print(f' Has _future_mask {f}')
        ...
        #print(f'dim:{dim} self._future_mask:{self._future_mask}')
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, args, index):
        ...
        if args.encoder_branch_type is None:
            ...
            #print (len(args.encoder_branch_type))
            #print(type(args.encoder_branch_type))
...
def base_architecture(args):
    ...
    args.adaptive_input = getattr(args, 'max-lr', 0.001)
    args.adaptive_input = getattr(args, 'min-lr', 1e-9)
    ...
    print('encoder_ffn_list:\n', args.encoder_ffn_list)
