...
def main(args):
    ...
    global delimiter_id
    delimiter_id = src_dict.index('#')
    print(f'********** delimiter_id:{delimiter_id}')
    ...
    def make_binary_dataset(vocab, input_prefix, output_prefix, lang, num_workers):
        ...
        #logger.info(f"---> offsets:{len(offsets)} {offsets}")
        pool = None
        if num_workers > 1:
...
def cli_main():
    ...
    parser.add_argument('--src-lang-delimiter', type=str, metavar='STR',\
        help='delimiter of src-lang. eg. --src-lang-delimiter \'#\'  STR: w o b u # wo bu  will split to  w o b u and wo bu')
    args = parser.parse_args()
    print(f'++++++++++ src-lang-delimiter:{args.src_lang_delimiter}')
    print('-'*50)
    print(f'args:{args}')
    print('-'*50)
    main(args)
